...
->setCellValue('F1', 'SHOOTING PIC')
->setCellValue('G1', 'SHOOTING DATE')
->setCellValue('H1', 'EDITING PIC')
->setCellValue('I1', 'EDITING DATE')
...
->setCellValue('F'.$i, $row->shooting_pic)
->setCellValue('G'.$i, $row->shooting_date)
->setCellValue('H'.$i, $row->editing_pic)
->setCellValue('I'.$i, $row->editing_date)
