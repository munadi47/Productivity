...
->setCellValue('F1', 'VOICEOVER DUE DATE')
->setCellValue('G1', 'ANIMATE PIC')
->setCellValue('H1', 'ANIMATE DUE DATE')
->setCellValue('I1', 'COMPILE PIC')
->setCellValue('J1', 'COMPILE DUE DATE')
...
exit;
    ...
    ->setCellValue('E1', 'VOICEOVER DUE DATE')
    ->setCellValue('F1', 'ANIMATE PIC')
    ->setCellValue('G1', 'ANIMATE DUE DATE')
    ->setCellValue('H1', 'COMPILE PIC')
    ->setCellValue('I1', 'COMPILE DUE DATE')
