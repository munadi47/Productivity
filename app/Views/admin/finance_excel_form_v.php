<section>
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page"><i class="fas fa-money-bill"></i> Finance</li>
    </ol>
    </nav>
    <div class="card shadow-sm p-3 mb-5 bg-white rounded notice notice-info" data-aos="fade-out" data-aos-duration="1000" >
                ...
                <br>
                <form method="POST" action="<?php echo site_url('Finance/do_upload'); ?>" enctype="multipart/form-data">
                <input type="file" class="form-control" id="finance_file" name="finance_file" />
