<section>
    ...
    <div class="card shadow-sm p-3 mb-5 bg-white rounded notice notice-info" data-aos="fade-out" data-aos-duration="1000" >
                ...
                <br>
                <form method="POST" action="<?php echo site_url('Company/do_upload'); ?>" enctype="multipart/form-data">
                <input type="file" class="form-control" id="company_file" name="company_file" />
